...
## [0.7.4](https://github.com/kixelated/web-transport-rs/compare/web-transport-quinn-v0.7.3...web-transport-quinn-v0.7.4) - 2025-08-05

### Other

- Allow using system roots in the example. ([#88](https://github.com/kixelated/web-transport-rs/pull/88))
- Add support for session closed capsule ([#86](https://github.com/kixelated/web-transport-rs/pull/86))
# Changelog
All notable changes to this project will be documented in this file.
