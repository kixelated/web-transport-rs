...
pub fn parse(request: &webtransport_quinn::Request) -> anyhow::Result<(u8, u16)> {
...
async fn recv_baton(mut recv: quinn::RecvStream) -> anyhow::Result<u8> {
...
async fn send_baton(mut send: quinn::SendStream, baton: u8) -> anyhow::Result<()> {
